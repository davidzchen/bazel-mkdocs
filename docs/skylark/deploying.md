...
Make sure to use a descriptive GitHub repository description and `README.html`
title, example:

* Repository: *bazelbuild/rules_go*
* Repository description: *"Go rules for Bazel"*
* Repository tags: `golang`, `bazel`
* `README.html` header: *"Go rules for [Bazel](https://bazel.build)"*
...
for the [Go
rules](https://github.com/bazelbuild/rules_go/blob/master/README.html#setup), this
looks like:
...
`README.html` (see the [Skydoc rules](https://github.com/bazelbuild/skydoc#setup),
