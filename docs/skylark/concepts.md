...
A [macro](macros.html) is a function that instantiates rules. It is useful when a
...
A [rule](rules.html) is more powerful than a macro. It can access Bazel internals
