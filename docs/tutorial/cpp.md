...
[Common C++ Build Use Cases](cpp-use-cases.html) for information on more advanced
...
To prepare for the tutorial, first [Install Bazel](../install.html) if
...
Next, read up on the most common [C++ build use cases](cpp-use-cases.html). Then,
...
*  The [Java build tutorial](java.html) to get started with
   building Java applications with Bazel.

*  The [mobile application tutorial](app.html) to get started with
